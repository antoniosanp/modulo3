...
export function nuevoProyectoCard(proyecto){
                        ...
                        <div class="weather-grid">
                            <div class="weather-item temp">
                                ...
                                <div class="weather-info">
                                    ...
                                    <span class="weather-value">${proyecto.datos.temperature_2m}°C</span>
                                </div>
                            </div>
                            <div class="weather-item wind">
                                ...
                                <div class="weather-info">
                                    ...
                                    <span class="weather-value">${proyecto.datos.wind_speed_10m} km/h</span>
                                </div>
                            </div>
                            <div class="weather-item rain">
                                ...
                                <div class="weather-info">
                                    ...
                                    <span class="weather-value">${proyecto.datos.precipitation} mm</span>
                                </div>
                            </div>
                        </div>
